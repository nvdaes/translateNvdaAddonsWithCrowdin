...
class AIResource(BaseResource):
	...
	def edit_ai_prompt(
		...
		userId: int,
		aiPromptId: int,
		request_data: Iterable[EditAIPromptScheme],
	):
		"""
		Edit AI Prompt
	...
	def edit_ai_provider(
		...
		userId: int,
		aiProviderId: int,
		request_data: EditAIProviderRequestScheme,
	):
		"""
		Edit AI Provider
	...
	def list_ai_provider_models(self, userId: int, aiProviderId: int):
		...
		return self.requester.request(
			method="get",
			path=self.get_ai_provider_path(userId=userId, aiProviderId=aiProviderId) + "/models",
		)
	...
	def create_ai_proxy_chat_completion(
		...
		return self.requester.request(
			method="post",
			path=self.get_ai_provider_path(userId=userId, aiProviderId=aiProviderId) + "/chat/completions",
			request_data=request_data,
		)
...
class EnterpriseAIResource(BaseResource):
	...
	def create_ai_proxy_chat_completion(
		...
		return self.requester.request(
			method="post",
			path=self.get_ai_provider_path(aiProviderId=aiProviderId) + "/chat/completions",
			request_data=request_data,
		)
